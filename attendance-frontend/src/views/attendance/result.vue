  ...
  <div class="page">
    <el-card>
      <template #header>
        ...
        <el-button type="primary" style="float:right" :loading="generateLoading" @click="doGenerateEmpty">{{ t('result.generateEmpty') }}</el-button>
      </template>
...
import { getResultPage, generateEmptyResult } from '../../api/result'
